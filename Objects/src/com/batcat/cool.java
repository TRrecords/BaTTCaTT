...
mostCurrent._l2.Initialize(mostCurrent.activityBA,"l2");
 //BA.debugLineNum = 87;BA.debugLine="AnimSet.Initialize(True)";
mostCurrent._animset.Initialize(anywheresoftware.b4a.keywords.Common.True);
...
mostCurrent._nativeme.InitializeContext(processBA);
 //BA.debugLineNum = 164;BA.debugLine="Panel2.Visible=False";
mostCurrent._panel2.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 166;BA.debugLine="ffil.Initialize";
mostCurrent._ffil.Initialize();
 //BA.debugLineNum = 167;BA.debugLine="ffold.Initialize";
mostCurrent._ffold.Initialize();
 //BA.debugLineNum = 169;BA.debugLine="Activity.SetColorAnimated(12000,mcl.md_amber_500,";
mostCurrent._activity.SetColorAnimated((int) (12000),mostCurrent._mcl.getmd_amber_500(),mostCurrent._mcl.getmd_lime_700());
 //BA.debugLineNum = 170;BA.debugLine="Label1.SetTextColorAnimated(9000,Colors.White)";
mostCurrent._label1.SetTextColorAnimated((int) (9000),anywheresoftware.b4a.keywords.Common.Colors.White);
 //BA.debugLineNum = 172;BA.debugLine="For h = 0 To clist.Size-1";
{
final int step89 = 1;
final int limit89 = (int) (mostCurrent._clist.getSize()-1);
for (_h = (int) (0) ; (step89 > 0 && _h <= limit89) || (step89 < 0 && _h >= limit89); _h = ((int)(0 + _h + step89)) ) {
 //BA.debugLineNum = 173;BA.debugLine="Log(clist.Get(h))";
anywheresoftware.b4a.keywords.Common.Log(BA.ObjectToString(mostCurrent._clist.Get(_h)));
 }
};
 //BA.debugLineNum = 175;BA.debugLine="andro=LoadBitmap(File.DirAssets,\"ic_autorenew_bla";
mostCurrent._andro = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_autorenew_black_48dp.png");
 //BA.debugLineNum = 176;BA.debugLine="bat=LoadBitmap(File.DirAssets,\"ic_data_usage_blac";
mostCurrent._bat = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_data_usage_black_48dp.png");
 //BA.debugLineNum = 177;BA.debugLine="desk=LoadBitmap(File.DirAssets, \"ic_battery_alert";
mostCurrent._desk = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_battery_alert_black_48dp.png");
 //BA.debugLineNum = 178;BA.debugLine="work=LoadBitmap(File.DirAssets, \"ic_delete_black_";
mostCurrent._work = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_delete_black_48dp.png");
 //BA.debugLineNum = 180;BA.debugLine="GetDeviceId";
_getdeviceid();
 //BA.debugLineNum = 181;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 182;BA.debugLine="loading_norm";
_loading_norm();
 //BA.debugLineNum = 183;BA.debugLine="clean_start";
_clean_start();
...
public static String  _activity_resume() throws Exception{
 ...
 //BA.debugLineNum = 187;BA.debugLine="t1.Enabled=True";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 188;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 189;BA.debugLine="loading_norm";
_loading_norm();
 //BA.debugLineNum = 190;BA.debugLine="clean_start";
_clean_start();
...
int _i = 0;
 //BA.debugLineNum = 582;BA.debugLine="Sub app_info";
 //BA.debugLineNum = 584;BA.debugLine="list1=pak.GetInstalledPackages";
mostCurrent._list1 = mostCurrent._pak.GetInstalledPackages();
 //BA.debugLineNum = 586;BA.debugLine="Obj1.Target = Obj1.GetContext";
mostCurrent._obj1.Target = (Object)(mostCurrent._obj1.GetContext(processBA));
 //BA.debugLineNum = 587;BA.debugLine="Obj1.Target = Obj1.RunMethod(\"getPackageManager\")";
mostCurrent._obj1.Target = mostCurrent._obj1.RunMethod("getPackageManager");
 //BA.debugLineNum = 588;BA.debugLine="Obj2.Target = Obj1.RunMethod2(\"getInstalledPackag";
mostCurrent._obj2.Target = mostCurrent._obj1.RunMethod2("getInstalledPackages",BA.NumberToString(0),"java.lang.int");
 //BA.debugLineNum = 589;BA.debugLine="size = Obj2.RunMethod(\"size\")";
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 594;BA.debugLine="For i = 0 To size -1";
{
final int step6 = 1;
final int limit6 = (int) (_size-1);
for (_i = (int) (0) ; (step6 > 0 && _i <= limit6) || (step6 < 0 && _i >= limit6); _i = ((int)(0 + _i + step6)) ) {
 //BA.debugLineNum = 595;BA.debugLine="Obj3.Target = Obj2.RunMethod2(\"get\", i, \"java.la";
...
_size = (int)(BA.ObjectToNumber(mostCurrent._obj2.RunMethod("size")));
 //BA.debugLineNum = 598;BA.debugLine="Obj3.Target = Obj3.GetField(\"applicationInfo\") '";
mostCurrent._obj3.Target = mostCurrent._obj3.GetField("applicationInfo");
 //BA.debugLineNum = 599;BA.debugLine="flags = Obj3.GetField(\"flags\")";
_flags = (int)(BA.ObjectToNumber(mostCurrent._obj3.GetField("flags")));
 //BA.debugLineNum = 600;BA.debugLine="packName = Obj3.GetField(\"packageName\")";
mostCurrent._packname = BA.ObjectToString(mostCurrent._obj3.GetField("packageName"));
 //BA.debugLineNum = 602;BA.debugLine="If Bit.And(flags, 1)  = 0 Then";
if (anywheresoftware.b4a.keywords.Common.Bit.And(_flags,(int) (1))==0) { 
 //BA.debugLineNum = 605;BA.debugLine="args(0) = Obj3.Target";
mostCurrent._args[(int) (0)] = mostCurrent._obj3.Target;
 //BA.debugLineNum = 606;BA.debugLine="Types(0) = \"android.content.pm.ApplicationInfo\"";
mostCurrent._types[(int) (0)] = "android.content.pm.ApplicationInfo";
 //BA.debugLineNum = 607;BA.debugLine="name = Obj1.RunMethod4(\"getApplicationLabel\", a";
mostCurrent._name = BA.ObjectToString(mostCurrent._obj1.RunMethod4("getApplicationLabel",mostCurrent._args,mostCurrent._types));
 //BA.debugLineNum = 608;BA.debugLine="icon = Obj1.RunMethod4(\"getApplicationIcon\", ar";
mostCurrent._icon.setObject((android.graphics.drawable.BitmapDrawable)(mostCurrent._obj1.RunMethod4("getApplicationIcon",mostCurrent._args,mostCurrent._types)));
 //BA.debugLineNum = 610;BA.debugLine="phlis.Add(icon.Bitmap)";
mostCurrent._phlis.Add((Object)(mostCurrent._icon.getBitmap()));
 //BA.debugLineNum = 611;BA.debugLine="list3.Add(packName)";
...
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
 //BA.debugLineNum = 622;BA.debugLine="Sub byte_to_object(data() As Byte)As Object";
 //BA.debugLineNum = 623;BA.debugLine="Dim ser As B4XSerializator";
_ser = new anywheresoftware.b4a.randomaccessfile.B4XSerializator();
 //BA.debugLineNum = 624;BA.debugLine="Return ser.ConvertBytesToObject(data)";
...
public static String  _c_start() throws Exception{
 //BA.debugLineNum = 204;BA.debugLine="Sub c_start";
 //BA.debugLineNum = 205;BA.debugLine="app_info";
_app_info();
 //BA.debugLineNum = 206;BA.debugLine="pgWheel1.Visible=False";
mostCurrent._pgwheel1.setVisible(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 207;BA.debugLine="dill.Clear";
mostCurrent._dill.Clear();
 //BA.debugLineNum = 208;BA.debugLine="reslist.Clear";
mostCurrent._reslist.Clear();
 //BA.debugLineNum = 209;BA.debugLine="piclist.Clear";
mostCurrent._piclist.Clear();
 //BA.debugLineNum = 210;BA.debugLine="filelist.Clear";
mostCurrent._filelist.Clear();
 //BA.debugLineNum = 211;BA.debugLine="apclist.Clear";
mostCurrent._apclist.Clear();
 //BA.debugLineNum = 212;BA.debugLine="list2.Clear";
mostCurrent._list2.Clear();
 //BA.debugLineNum = 213;BA.debugLine="list4.Clear";
mostCurrent._list4.Clear();
 //BA.debugLineNum = 214;BA.debugLine="phlis.Clear";
mostCurrent._phlis.Clear();
 //BA.debugLineNum = 215;BA.debugLine="piclist.Add(andro)";
mostCurrent._piclist.Add((Object)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 216;BA.debugLine="piclist.Add(bat)";
mostCurrent._piclist.Add((Object)(mostCurrent._bat.getObject()));
 //BA.debugLineNum = 217;BA.debugLine="piclist.Add(desk)";
mostCurrent._piclist.Add((Object)(mostCurrent._desk.getObject()));
 //BA.debugLineNum = 218;BA.debugLine="li4";
_li4();
 //BA.debugLineNum = 219;BA.debugLine="cat_start";
_cat_start();
...
long _size1 = 0L;
String _f = "";
 //BA.debugLineNum = 678;BA.debugLine="Sub CalcSize(Folder As String, recursive As Boolea";
 //BA.debugLineNum = 679;BA.debugLine="Dim size1 As Long";
_size1 = 0L;
 //BA.debugLineNum = 680;BA.debugLine="For Each f As String In File.ListFiles(Folder)";
...
_f = BA.ObjectToString(group2.Get(index2));
 //BA.debugLineNum = 681;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 682;BA.debugLine="If File.IsDirectory(Folder, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,_f)) { 
 //BA.debugLineNum = 683;BA.debugLine="size1 = size1 + CalcSize(File.Combine(Folder,";
_size1 = (long) (_size1+_calcsize(anywheresoftware.b4a.keywords.Common.File.Combine(_folder,_f),_recursive));
 };
 };
 //BA.debugLineNum = 686;BA.debugLine="size1 = size1 + File.Size(Folder, f)";
_size1 = (long) (_size1+anywheresoftware.b4a.keywords.Common.File.Size(_folder,_f));
 }
;
 //BA.debugLineNum = 688;BA.debugLine="Return size1";
if (true) return _size1;
 //BA.debugLineNum = 689;BA.debugLine="End Sub";
return 0L;
}
public static String  _cat_start() throws Exception{
 //BA.debugLineNum = 279;BA.debugLine="Sub cat_start";
 //BA.debugLineNum = 280;BA.debugLine="count=count+1";
_count = (int) (_count+1);
...
public static String  _del_quest() throws Exception{
 ...
 //BA.debugLineNum = 324;BA.debugLine="pgWheel1.Visible=False";
mostCurrent._pgwheel1.setVisible(anywheresoftware.b4a.keywords.Common.False);
...
_real_delete();
 //BA.debugLineNum = 330;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 331;BA.debugLine="End Sub";
return "";
}
public static String  _delayed_t2() throws Exception{
 //BA.debugLineNum = 493;BA.debugLine="Sub delayed_t2";
 //BA.debugLineNum = 494;BA.debugLine="pg.Progress=100";
mostCurrent._pg.setProgress((int) (100));
 //BA.debugLineNum = 495;BA.debugLine="If count = 15 Then";
if (_count==15) { 
 //BA.debugLineNum = 496;BA.debugLine="catdel.clearCache";
mostCurrent._catdel.clearCache();
 //BA.debugLineNum = 497;BA.debugLine="t1.Enabled=False";
_t1.setEnabled(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 498;BA.debugLine="ToastMessageShow(op.formatSize(cat.FreeMemory)&\"";
anywheresoftware.b4a.keywords.Common.ToastMessageShow(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())+" free"),anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 499;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 };
...
public static String  _fc_copydone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 628;BA.debugLine="Sub fc_CopyDone(Key As String, Error As Boolean)";
 //BA.debugLineNum = 630;BA.debugLine="End Sub";
return "";
}
public static String  _fc_putdone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 632;BA.debugLine="Sub fc_PutDone(key As String,Error As Boolean)";
 //BA.debugLineNum = 634;BA.debugLine="End Sub";
return "";
}
public static String  _fc2_putdone(String _key,boolean _error) throws Exception{
 //BA.debugLineNum = 636;BA.debugLine="Sub fc2_PutDone(key As String,Error As Boolean)";
 //BA.debugLineNum = 638;BA.debugLine="End Sub";
return "";
}
public static String  _file_copydone() throws Exception{
 //BA.debugLineNum = 691;BA.debugLine="Sub file_CopyDone";
 //BA.debugLineNum = 692;BA.debugLine="Log(\"copy done!\")";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 660;BA.debugLine="Sub GetActivitiesInfo(package As String) As Object";
 //BA.debugLineNum = 661;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 662;BA.debugLine="r.Target = r.GetContext";
_r.Target = (Object)(_r.GetContext(processBA));
 //BA.debugLineNum = 663;BA.debugLine="r.Target = r.RunMethod(\"getPackageManager\")";
_r.Target = _r.RunMethod("getPackageManager");
 //BA.debugLineNum = 664;BA.debugLine="r.Target = r.RunMethod3(\"getPackageInfo\", package";
_r.Target = _r.RunMethod3("getPackageInfo",_package,"java.lang.String",BA.NumberToString(0x00000001),"java.lang.int");
 //BA.debugLineNum = 665;BA.debugLine="Return r.GetField(\"applicationInfo\")";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
int _id = 0;
 //BA.debugLineNum = 222;BA.debugLine="Sub GetDeviceId As String";
 //BA.debugLineNum = 223;BA.debugLine="Dim api As Int";
_api = 0;
 //BA.debugLineNum = 224;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 225;BA.debugLine="api = r.GetStaticField(\"android.os.Build$VERSION\"";
_api = (int)(BA.ObjectToNumber(_r.GetStaticField("android.os.Build$VERSION","SDK_INT")));
 //BA.debugLineNum = 226;BA.debugLine="If api < 18 Then";
if (_api<18) { 
 //BA.debugLineNum = 228;BA.debugLine="If File.Exists(File.DirInternal, \"__id\") Then";
if (anywheresoftware.b4a.keywords.Common.File.Exists(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id")) { 
 //BA.debugLineNum = 229;BA.debugLine="Return File.ReadString(File.DirInternal, \"__id\"";
if (true) return anywheresoftware.b4a.keywords.Common.File.ReadString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id");
 //BA.debugLineNum = 230;BA.debugLine="c_start";
_c_start();
 }else {
 //BA.debugLineNum = 232;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 233;BA.debugLine="Dim id As Int";
_id = 0;
 //BA.debugLineNum = 234;BA.debugLine="id = Rnd(0x10000000, 0x7FFFFFFF)";
_id = anywheresoftware.b4a.keywords.Common.Rnd((int) (0x10000000),(int) (0x7fffffff));
 //BA.debugLineNum = 235;BA.debugLine="File.WriteString(File.DirInternal, \"__id\", id)";
anywheresoftware.b4a.keywords.Common.File.WriteString(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"__id",BA.NumberToString(_id));
 //BA.debugLineNum = 236;BA.debugLine="Return id";
if (true) return BA.NumberToString(_id);
 };
 //BA.debugLineNum = 238;BA.debugLine="Log(api)";
anywheresoftware.b4a.keywords.Common.Log(BA.NumberToString(_api));
 }else {
 //BA.debugLineNum = 241;BA.debugLine="Return r.GetStaticField(\"android.os.Build\", \"SER";
if (true) return BA.ObjectToString(_r.GetStaticField("android.os.Build","SERIAL"));
 //BA.debugLineNum = 245;BA.debugLine="storage_check";
_storage_check();
 };
...
long _siz = 0L;
String _f = "";
 //BA.debugLineNum = 554;BA.debugLine="Sub getdir(dir As String, recursive As Boolean) As";
 //BA.debugLineNum = 555;BA.debugLine="Dim si As String";
_si = "";
 //BA.debugLineNum = 556;BA.debugLine="Dim siz As Long";
_siz = 0L;
 //BA.debugLineNum = 557;BA.debugLine="For Each f As String In File.ListFiles(dir)";
...
_f = BA.ObjectToString(group3.Get(index3));
 //BA.debugLineNum = 558;BA.debugLine="If recursive Then";
if (_recursive) { 
 //BA.debugLineNum = 559;BA.debugLine="If File.IsDirectory(dir, f) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_dir,_f)) { 
 //BA.debugLineNum = 560;BA.debugLine="si = dir";
_si = _dir;
 //BA.debugLineNum = 561;BA.debugLine="Log(si)";
anywheresoftware.b4a.keywords.Common.Log(_si);
 //BA.debugLineNum = 562;BA.debugLine="siz = siz + getdir(File.Combine(dir, f),recurs";
_siz = (long) (_siz+_getdir(anywheresoftware.b4a.keywords.Common.File.Combine(_dir,_f),_recursive));
 };
 };
 //BA.debugLineNum = 565;BA.debugLine="siz = siz + File.Size(dir, f)";
_siz = (long) (_siz+anywheresoftware.b4a.keywords.Common.File.Size(_dir,_f));
 }
;
 //BA.debugLineNum = 567;BA.debugLine="Return siz";
if (true) return _siz;
...
String _l = "";
String _path1 = "";
 //BA.debugLineNum = 640;BA.debugLine="Sub GetParentPath(Path As String) As String";
 //BA.debugLineNum = 641;BA.debugLine="Dim L As String";
_l = "";
 //BA.debugLineNum = 642;BA.debugLine="Dim Path1 As String";
_path1 = "";
 //BA.debugLineNum = 643;BA.debugLine="If Path = \"/\" Then";
if ((_path).equals("/")) { 
 //BA.debugLineNum = 644;BA.debugLine="Return \"/\"";
if (true) return "/";
 };
 //BA.debugLineNum = 646;BA.debugLine="L = Path.LastIndexOf(\"/\")";
_l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 647;BA.debugLine="If L = Path.Length - 1 Then";
if ((_l).equals(BA.NumberToString(_path.length()-1))) { 
 //BA.debugLineNum = 649;BA.debugLine="Path1 = Path.SubString2(0,L)";
_path1 = _path.substring((int) (0),(int)(Double.parseDouble(_l)));
 }else {
 //BA.debugLineNum = 651;BA.debugLine="Path1 = Path";
_path1 = _path;
 };
 //BA.debugLineNum = 653;BA.debugLine="L = Path.LastIndexOf(\"/\")";
_l = BA.NumberToString(_path.lastIndexOf("/"));
 //BA.debugLineNum = 654;BA.debugLine="If L = 0 Then";
if ((_l).equals(BA.NumberToString(0))) { 
 //BA.debugLineNum = 655;BA.debugLine="L = 1";
_l = BA.NumberToString(1);
 };
 //BA.debugLineNum = 657;BA.debugLine="Return Path1.SubString2(0,L)";
...
anywheresoftware.b4a.agraham.reflection.Reflection _r = null;
 //BA.debugLineNum = 668;BA.debugLine="Sub GetSourceDir(AppInfo As Object) As String";
 //BA.debugLineNum = 669;BA.debugLine="Try";
try { //BA.debugLineNum = 670;BA.debugLine="Dim r As Reflector";
_r = new anywheresoftware.b4a.agraham.reflection.Reflection();
 //BA.debugLineNum = 671;BA.debugLine="r.Target = AppInfo";
_r.Target = _appinfo;
 //BA.debugLineNum = 672;BA.debugLine="Return r.GetField(\"sourceDir\")";
if (true) return BA.ObjectToString(_r.GetField("sourceDir"));
 } 
       catch (Exception e6) {
			processBA.setLastException(e6); //BA.debugLineNum = 674;BA.debugLine="Return \"\"";
if (true) return "";
 };
...
mostCurrent._l3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 27;BA.debugLine="Dim AnimSet As AnimationSet";
mostCurrent._animset = new flm.b4a.animationplus.AnimationSet();
 //BA.debugLineNum = 28;BA.debugLine="Dim ph As PhoneEvents";
mostCurrent._ph = new anywheresoftware.b4a.phone.PhoneEvents();
 //BA.debugLineNum = 29;BA.debugLine="Dim size,flags,count As Int";
_size = 0;
_flags = 0;
_count = 0;
 //BA.debugLineNum = 30;BA.debugLine="Dim ffiles,ffolders As List";
...
;
 //BA.debugLineNum = 40;BA.debugLine="Dim paths As Map";
mostCurrent._paths = new anywheresoftware.b4a.objects.collections.Map();
 //BA.debugLineNum = 41;BA.debugLine="Dim panel1 As Panel";
mostCurrent._panel1 = new anywheresoftware.b4a.objects.PanelWrapper();
 //BA.debugLineNum = 42;BA.debugLine="Dim storage As env";
mostCurrent._storage = new de.donmanfred.storage();
 //BA.debugLineNum = 43;BA.debugLine="Dim de As String = File.DirRootExternal";
mostCurrent._de = anywheresoftware.b4a.keywords.Common.File.getDirRootExternal();
 //BA.debugLineNum = 44;BA.debugLine="Dim mtc As Matcher = Regex.Matcher(\"(/|\\\\)[^(/|\\\\";
...
mostCurrent._mtc = anywheresoftware.b4a.keywords.Common.Regex.Matcher("(/|\\\\)[^(/|\\\\)]*(/|\\\\)",mostCurrent._de);
 //BA.debugLineNum = 45;BA.debugLine="Dim extsdcard As String = de";
mostCurrent._extsdcard = mostCurrent._de;
 //BA.debugLineNum = 46;BA.debugLine="Dim nativeMe As JavaObject";
...
mostCurrent._imageview1 = new anywheresoftware.b4a.objects.ImageViewWrapper();
 //BA.debugLineNum = 51;BA.debugLine="Private pg As NumberProgressBar";
mostCurrent._pg = new de.donmanfred.NumberProgressBarWrapper();
 //BA.debugLineNum = 52;BA.debugLine="Dim ffil,ffold As List";
...
mostCurrent._ffold = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 54;BA.debugLine="Dim rot As String";
mostCurrent._rot = "";
 //BA.debugLineNum = 55;BA.debugLine="Private pgWheel1 As pgWheel";
mostCurrent._pgwheel1 = new de.donmanfred.pgWheel();
 //BA.debugLineNum = 56;BA.debugLine="Dim andro,bat,desk,work As Bitmap";
...
mostCurrent._work = new anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper();
 //BA.debugLineNum = 58;BA.debugLine="Private mcl As MaterialColors";
...
anywheresoftware.b4a.randomaccessfile.B4XSerializator _ser = null;
 //BA.debugLineNum = 617;BA.debugLine="Sub object_to_byte(obj As Object)As Byte()";
 //BA.debugLineNum = 618;BA.debugLine="Dim ser As B4XSerializator";
_ser = new anywheresoftware.b4a.randomaccessfile.B4XSerializator();
 //BA.debugLineNum = 619;BA.debugLine="Return ser.ConvertObjectToBytes(obj)";
...
String _tr = "";
 //BA.debugLineNum = 503;BA.debugLine="Sub pg_onProgressChange(current As Int, maxvalue A";
 //BA.debugLineNum = 504;BA.debugLine="andro.Initialize(File.DirAssets,\"Android.png\")";
mostCurrent._andro.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Android.png");
 //BA.debugLineNum = 505;BA.debugLine="bat.Initialize(File.DirAssets,\"Battery.png\")";
mostCurrent._bat.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Battery.png");
 //BA.debugLineNum = 506;BA.debugLine="desk.Initialize(File.DirAssets, \"Chart.png\")";
mostCurrent._desk.Initialize(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Chart.png");
 //BA.debugLineNum = 507;BA.debugLine="maxvalue=100";
_maxvalue = (int) (100);
 //BA.debugLineNum = 508;BA.debugLine="If current=count+1 Then";
if (_current==_count+1) { 
 //BA.debugLineNum = 509;BA.debugLine="For Each tr As String In reslist";
...
_tr = BA.ObjectToString(group6.Get(index6));
 //BA.debugLineNum = 510;BA.debugLine="Log(tr)";
anywheresoftware.b4a.keywords.Common.Log(_tr);
 //BA.debugLineNum = 511;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 512;BA.debugLine="Label1.Text=tr";
mostCurrent._label1.setText(BA.ObjectToCharSequence(_tr));
 }
;
 };
 //BA.debugLineNum = 515;BA.debugLine="If current=100 Then";
if (_current==100) { 
 //BA.debugLineNum = 516;BA.debugLine="ImageView1.Bitmap=LoadBitmap(File.DirAssets,\"Acc";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"Accept128.png").getObject()));
 };
...
public static String  _ph_devicestorageok(anywheresoftware.b4a.objects.IntentWrapper _intent) throws Exception{
 //BA.debugLineNum = 385;BA.debugLine="Sub ph_DeviceStorageOk (Intent As Intent)";
 //BA.debugLineNum = 386;BA.debugLine="Log(Intent.ExtrasToString)";
...
int _i = 0;
String _v = "";
 //BA.debugLineNum = 535;BA.debugLine="Sub ReadDir(folder As String, recursive As Boolean";
 //BA.debugLineNum = 537;BA.debugLine="Dim lst As List = File.ListFiles(folder)";
_lst = new anywheresoftware.b4a.objects.collections.List();
_lst = anywheresoftware.b4a.keywords.Common.File.ListFiles(_folder);
 //BA.debugLineNum = 538;BA.debugLine="For i = 0 To lst.Size - 1";
{
final int step2 = 1;
final int limit2 = (int) (_lst.getSize()-1);
for (_i = (int) (0) ; (step2 > 0 && _i <= limit2) || (step2 < 0 && _i >= limit2); _i = ((int)(0 + _i + step2)) ) {
 //BA.debugLineNum = 539;BA.debugLine="If File.IsDirectory(folder,lst.Get(i)) Then";
if (anywheresoftware.b4a.keywords.Common.File.IsDirectory(_folder,BA.ObjectToString(_lst.Get(_i)))) { 
 //BA.debugLineNum = 540;BA.debugLine="Dim v As String";
_v = "";
 //BA.debugLineNum = 541;BA.debugLine="v = folder&\"/\"&lst.Get(i)";
_v = _folder+"/"+BA.ObjectToString(_lst.Get(_i));
 //BA.debugLineNum = 543;BA.debugLine="ffold.Add(v.SubString(rot.Length+1))";
...
if (_recursive) { 
 //BA.debugLineNum = 545;BA.debugLine="ReadDir(v,recursive)";
_readdir(_v,_recursive);
 };
 }else {
 //BA.debugLineNum = 548;BA.debugLine="ffil.Add(folder&\"/\"&lst.Get(i))";
...
uk.co.martinpearman.b4a.activitymanager.RunningTaskInfo _runningtaskinfo1 = null;
 ...
 //BA.debugLineNum = 352;BA.debugLine="pgWheel1.Progress=360";
...
String _f = "";
 //BA.debugLineNum = 249;BA.debugLine="Sub storage_check";
 //BA.debugLineNum = 250;BA.debugLine="For i = 0 To paths.Size-1";
{
final int step1 = 1;
final int limit1 = (int) (mostCurrent._paths.getSize()-1);
for (_i = (int) (0) ; (step1 > 0 && _i <= limit1) || (step1 < 0 && _i >= limit1); _i = ((int)(0 + _i + step1)) ) {
 //BA.debugLineNum = 251;BA.debugLine="Log(paths.GetKeyAt(i)&\"=\"&paths.GetValueAt(i))";
...
anywheresoftware.b4a.keywords.Common.Log("DirRootExternal = "+mostCurrent._de);
 //BA.debugLineNum = 256;BA.debugLine="If mtc.Find = True Then";
if (mostCurrent._mtc.Find()==anywheresoftware.b4a.keywords.Common.True) { 
 //BA.debugLineNum = 257;BA.debugLine="Dim mnt As String = mtc.Group(0)";
_mnt = mostCurrent._mtc.Group((int) (0));
 //BA.debugLineNum = 259;BA.debugLine="Log (\"mount point = \"& mnt)";
anywheresoftware.b4a.keywords.Common.Log("mount point = "+_mnt);
 //BA.debugLineNum = 260;BA.debugLine="Dim dirs As List = File.ListFiles(mnt)";
_dirs = new anywheresoftware.b4a.objects.collections.List();
_dirs = anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt);
 //BA.debugLineNum = 261;BA.debugLine="For Each f As String In dirs";
...
_f = BA.ObjectToString(group9.Get(index9));
 //BA.debugLineNum = 262;BA.debugLine="If storage.isExternalStorageRemovable(mnt&f) Th";
if (mostCurrent._storage.isExternalStorageRemovable(_mnt+_f)) { 
 //BA.debugLineNum = 263;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is removable\")";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is removable");
 //BA.debugLineNum = 264;BA.debugLine="If File.ListFiles(mnt&f).IsInitialized Then";
if (anywheresoftware.b4a.keywords.Common.File.ListFiles(_mnt+_f).IsInitialized()) { 
 //BA.debugLineNum = 265;BA.debugLine="Log(\"probably ExtSDCard: \"&mnt&f)";
anywheresoftware.b4a.keywords.Common.Log("probably ExtSDCard: "+_mnt+_f);
 //BA.debugLineNum = 266;BA.debugLine="extsdcard = mnt&f";
mostCurrent._extsdcard = _mnt+_f;
 }else {
 };
 }else {
 //BA.debugLineNum = 271;BA.debugLine="Log (\"Device = \"& f&\":\"&mnt&f&\" is NOT removab";
anywheresoftware.b4a.keywords.Common.Log("Device = "+_f+":"+_mnt+_f+" is NOT removable");
 };
 }
;
 };
 //BA.debugLineNum = 275;BA.debugLine="Activity.SetColorAnimated(1000,Colors.ARGB(100,30";
mostCurrent._activity.SetColorAnimated((int) (1000),anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (100),(int) (30),(int) (124),(int) (235)),anywheresoftware.b4a.keywords.Common.Colors.ARGB((int) (190),(int) (35),(int) (140),(int) (7)));
 //BA.debugLineNum = 276;BA.debugLine="c_start";
_c_start();
 //BA.debugLineNum = 277;BA.debugLine="End Sub";
return "";
}
public static String  _t1_tick() throws Exception{
 //BA.debugLineNum = 389;BA.debugLine="Sub t1_Tick";
 //BA.debugLineNum = 390;BA.debugLine="andro=LoadBitmap(File.DirAssets,\"ic_autorenew_bla";
mostCurrent._andro = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_autorenew_black_48dp.png");
 //BA.debugLineNum = 391;BA.debugLine="bat=LoadBitmap(File.DirAssets,\"ic_data_usage_blac";
mostCurrent._bat = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_data_usage_black_48dp.png");
 //BA.debugLineNum = 392;BA.debugLine="desk=LoadBitmap(File.DirAssets, \"ic_battery_alert";
mostCurrent._desk = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_battery_alert_black_48dp.png");
 //BA.debugLineNum = 393;BA.debugLine="work=LoadBitmap(File.DirAssets, \"ic_delete_black_";
mostCurrent._work = anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"ic_delete_black_48dp.png");
 //BA.debugLineNum = 394;BA.debugLine="pgWheel1.Visible=True";
mostCurrent._pgwheel1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 395;BA.debugLine="pgWheel1.SpinSpeed=100";
mostCurrent._pgwheel1.setSpinSpeed((int) (100));
 //BA.debugLineNum = 396;BA.debugLine="pgWheel1.spin";
mostCurrent._pgwheel1.spin();
 //BA.debugLineNum = 397;BA.debugLine="ListView1.Visible=True";
mostCurrent._listview1.setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 398;BA.debugLine="pg.SetColorAnimated(12000,Colors.Transparent,mcl.";
mostCurrent._pg.SetColorAnimated((int) (12000),anywheresoftware.b4a.keywords.Common.Colors.Transparent,mostCurrent._mcl.getmd_lime_A700());
 //BA.debugLineNum = 399;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 400;BA.debugLine="count=count+1";
_count = (int) (_count+1);
 //BA.debugLineNum = 401;BA.debugLine="pg.incrementProgressBy(count)";
mostCurrent._pg.incrementProgressBy(_count);
 //BA.debugLineNum = 402;BA.debugLine="If count>0 Then";
if (_count>0) { 
 //BA.debugLineNum = 403;BA.debugLine="Label1.Text=\"check Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check Battery.."));
 };
 //BA.debugLineNum = 405;BA.debugLine="If count > 1 Then";
if (_count>1) { 
 //BA.debugLineNum = 406;BA.debugLine="Label1.Text=\"check Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check Battery.."));
 };
 //BA.debugLineNum = 408;BA.debugLine="If count > 2 Then";
if (_count>2) { 
 //BA.debugLineNum = 409;BA.debugLine="Label1.Text=\"check Battery..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check Battery.."));
 };
 //BA.debugLineNum = 412;BA.debugLine="If count > 3 Then";
if (_count>3) { 
 //BA.debugLineNum = 414;BA.debugLine="Label1.Text=\"check System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check System.."));
 //BA.debugLineNum = 415;BA.debugLine="ListView1.AddTwoLinesAndBitmap(\"System Prozesse:";
mostCurrent._listview1.AddTwoLinesAndBitmap(BA.ObjectToCharSequence("System Prozesse:"),BA.ObjectToCharSequence(BA.NumberToString(mostCurrent._list2.getSize())+" gefunden."),(android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 ...
 //BA.debugLineNum = 417;BA.debugLine="If count > 4 Then";
if (_count>4) { 
 //BA.debugLineNum = 419;BA.debugLine="ListView1.Clear";
mostCurrent._listview1.Clear();
 //BA.debugLineNum = 420;BA.debugLine="Label1.Text=\"check System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check System.."));
 };
 //BA.debugLineNum = 423;BA.debugLine="If count > 5 Then";
if (_count>5) { 
 //BA.debugLineNum = 425;BA.debugLine="pgWheel1.SpinSpeed=200";
mostCurrent._pgwheel1.setSpinSpeed((int) (200));
 //BA.debugLineNum = 426;BA.debugLine="ImageView1.Bitmap=bat";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._bat.getObject()));
 //BA.debugLineNum = 427;BA.debugLine="Label1.Text=\"clear Cache System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("clear Cache System.."));
 };
 //BA.debugLineNum = 430;BA.debugLine="If count > 6 Then";
if (_count>6) { 
 //BA.debugLineNum = 431;BA.debugLine="Label1.Text=\"defrag File System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("defrag File System.."));
 };
 //BA.debugLineNum = 433;BA.debugLine="If count > 7 Then";
if (_count>7) { 
 //BA.debugLineNum = 434;BA.debugLine="Label1.Text=\"search SDCard System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("search SDCard System.."));
 //BA.debugLineNum = 435;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 };
 //BA.debugLineNum = 441;BA.debugLine="If count > 8 Then";
if (_count>8) { 
 //BA.debugLineNum = 442;BA.debugLine="Label1.Text=\"clear Cache System..\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("clear Cache System.."));
 //BA.debugLineNum = 443;BA.debugLine="ImageView1.Bitmap=desk";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._desk.getObject()));
 //BA.debugLineNum = 444;BA.debugLine="Label1.Text=\"check \"&op.formatSize(op.Availabl";
mostCurrent._label1.setText(BA.ObjectToCharSequence("check "+mostCurrent._op.formatSize(mostCurrent._op.getAvailableMemory())));
 };
 //BA.debugLineNum = 446;BA.debugLine="If count > 9 Then";
if (_count>9) { 
 //BA.debugLineNum = 447;BA.debugLine="pgWheel1.SpinSpeed=100";
mostCurrent._pgwheel1.setSpinSpeed((int) (100));
 //BA.debugLineNum = 448;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 };
 //BA.debugLineNum = 451;BA.debugLine="If count > 10 Then";
if (_count>10) { 
 //BA.debugLineNum = 452;BA.debugLine="ImageView1.Bitmap=desk";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._desk.getObject()));
 //BA.debugLineNum = 453;BA.debugLine="Label1.Text=\"Running Process: \"&  list3.Size";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Running Process: "+BA.NumberToString(mostCurrent._list3.getSize())));
 };
 //BA.debugLineNum = 456;BA.debugLine="If count > 11 Then";
if (_count>11) { 
 //BA.debugLineNum = 457;BA.debugLine="ImageView1.Bitmap=bat";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._bat.getObject()));
 };
 //BA.debugLineNum = 459;BA.debugLine="If count > 12 Then";
if (_count>12) { 
 //BA.debugLineNum = 460;BA.debugLine="If Not (filelist.Size=0) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._filelist.getSize()==0)) { 
 //BA.debugLineNum = 461;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 }else {
 //BA.debugLineNum = 464;BA.debugLine="ImageView1.Bitmap=desk";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._desk.getObject()));
 //BA.debugLineNum = 465;BA.debugLine="Label1.Text=\"Clear!\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence("Clear!"));
 };
 //BA.debugLineNum = 468;BA.debugLine="pgWheel1.stopSpinning";
mostCurrent._pgwheel1.stopSpinning();
 };
 //BA.debugLineNum = 472;BA.debugLine="If count > 13 Then";
if (_count>13) { 
 //BA.debugLineNum = 473;BA.debugLine="Label1.Text=op.formatSize(cat.FreeMemory)";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._op.formatSize(mostCurrent._cat.getFreeMemory())));
 //BA.debugLineNum = 474;BA.debugLine="If Not (filelist.Size=1) Then";
if (anywheresoftware.b4a.keywords.Common.Not(mostCurrent._filelist.getSize()==1)) { 
 //BA.debugLineNum = 475;BA.debugLine="pgWheel1.Progress=180";
mostCurrent._pgwheel1.setProgress((int) (180));
 //BA.debugLineNum = 476;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 477;BA.debugLine="Label1.Text=nativeMe.RunMethod(\"getOSCodename\"";
mostCurrent._label1.setText(BA.ObjectToCharSequence(mostCurrent._nativeme.RunMethod("getOSCodename",(Object[])(anywheresoftware.b4a.keywords.Common.Null))));
 //BA.debugLineNum = 478;BA.debugLine="ImageView1.Bitmap=bat";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._bat.getObject()));
 }else {
 //BA.debugLineNum = 480;BA.debugLine="ImageView1.Bitmap=andro";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._andro.getObject()));
 //BA.debugLineNum = 482;BA.debugLine="ImageView1.Bitmap=desk";
mostCurrent._imageview1.setBitmap((android.graphics.Bitmap)(mostCurrent._desk.getObject()));
 };
 };
 //BA.debugLineNum = 487;BA.debugLine="If count > 14 Then";
if (_count>14) { 
 //BA.debugLineNum = 488;BA.debugLine="pgWheel1.Progress=360";
mostCurrent._pgwheel1.setProgress((int) (360));
 //BA.debugLineNum = 489;BA.debugLine="CallSub(Me,\"del_quest\")";
